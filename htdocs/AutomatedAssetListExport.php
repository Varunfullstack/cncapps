...
while ($dbeCustomer->fetchNext()) {
  ...
  if(exd.`Bitlocker Password/Key` is not null and exd.`Bitlocker Password/Key` regexp '[0-9]{6}-[0-9]{6}-[0-9]{6}-[0-9]{6}-[0-9]{6}-[0-9]{6}-[0-9]{6}-[0-9]{6}','Encrypted',null) as 'Drive Encryption',
  SUBSTRING_INDEX(
    computers.os,
    'Microsoft Windows ',
    - 1
