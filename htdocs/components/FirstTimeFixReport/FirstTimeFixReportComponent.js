...
class FirstTimeFixReportComponent extends MainComponent {
  ...
  getFirstTimeElement=()=>{
    ...
    return <table className="table table-striped" style={{width:600}}>
      <thead>
        <tr>
          <th>Name</th>
          <th>Raised</th>
  ...
  getNotFirstTimeElement=()=>{
    ...
    return <table className="table table-striped" style={{width:1200}}>
      <thead>
        <tr>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href= {`Activity.php?action=displayLastActivity&problemID=${e.problemID}`} target= {"_blank"} > {e.problemID}</a>
           </td>
