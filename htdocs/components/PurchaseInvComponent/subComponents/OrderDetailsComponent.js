      ...
      <table>
        <tbody>
          <tr>
            ...
            <td><input type="text" className="form-control" value={invoiceNo} onChange={(event)=>this.setState({invoiceNo:event.target.value})}></input></td>
    ...
    return (
      <div>
        ...
        <div className="modal-footer">
          <button onClick={()=>this.openTab(`PurchaseOrder.php?action=display&porheadID=${this.props.porheadID}`)}>Purchase Order</button>
          <button onClick={()=>this.openPopup(`SalesOrder.php?action=displaySalesOrder&ordheadID=${this.props.ordheadID}&htmlFmt=popup`)}>Sales Order</button>
