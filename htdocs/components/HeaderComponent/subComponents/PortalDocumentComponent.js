            ...
            <table className="table" key="tableContent">
                <tbody>
                    <tr>
                        <td>Description	</td>
                        <td>
                            <input className="form-control" value={data?.description} onChange={(event)=>this.setValue("description",event.target.value)}></input>
                        </td>
                    </tr>
                    <tr>
                        <td>Main Contact Only?</td>
                        <td>
                            <Toggle checked={data?.mainContactOnlyFlag=="Y"} onChange={()=>this.setValue("mainContactOnlyFlag",data.mainContactOnlyFlag=="Y"?"N":"Y")}>
                            </Toggle>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                        <Toggle checked={data?.requiresAcceptanceFlag=="Y"} onChange={()=>this.setValue("requiresAcceptanceFlag",data.requiresAcceptanceFlag=="Y"?"N":"Y")}>
                        </Toggle>
                        </td>
                    </tr>
                    <tr>
