...
class CMPInboxPendingReopened extends MainComponent{
  code = "PR";
    ...
    let columns = [
      {
       ...
       },
       {
        ...
        hdToolTip:"Customer",
        content: (problem) =>
         el('a',{className:"pointer",onClick:()=>this.openPopup(`CurrentActivityReport.php?action=pendingReopenedPopup&pendingReopenedID=${problem.pendingReopenedID}&htmlFmt=popup`)},problem.pendingReopenDescriptionSummary)
       },
       {
        hide: false,
        order: 8,
