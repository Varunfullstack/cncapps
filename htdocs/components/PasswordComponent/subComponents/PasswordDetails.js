    ...
    getModalElement=()=>{
        ...
        content={
            <div key="content">
                ...
                <div className="form-group">
                  <label >Service</label>
                  <select className="form-control" value={data.serviceID} onChange={(event)=>this.setValue("serviceID",event.target.value)} >
                ...
                <div className="form-group">
                  ...
                  <input value={data.password} type="text" name="" id="" className="form-control" onChange={(event)=>this.setValue("password",event.target.value)} />                   
                </div>                
                <div className="form-group">
                  <label >Notes</label>
                  <input value={data.notes} type="text" name="" id="" className="form-control" onChange={(event)=>this.setValue("notes",event.target.value)} />                   
                </div>
                <div className="form-group">
                  <label >URL</label>
                  <input value={data.URL} type="text" name="" id="" className="form-control" onChange={(event)=>this.setValue("URL",event.target.value)} />                   
                </div>
                <div className="form-group">
                  <label >Level</label>                  
        ...
        footer={<div key="footer">                
                <button className="btn btn-secondary" onClick={()=>window.open('Password.php?action=generate&htmlFmt=popup','reason','scrollbars=yes,resizable=yes,height=524,width=855,copyhistory=no, menubar=0' )}> Generate Password</button>
