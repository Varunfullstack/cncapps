        ...
        const columns=[
            ...
            },
            {
             ...
             },
             {
                ...
                content:(order)=>{
                    if(order.orderId>0)
                    return <a href={`SalesOrder.php?action=displaySalesOrder&ordheadID=${order.orderId}`} target="_blank">{order.orderId}</a>                    
                }
             },
             {
                path: "startDate",
             ...
             },
             {
                ...
                backgroundColorColumn:"sentQuotationColor",
                content:(order)=>{                     
                    return <a href={`RenQuotation.php?action=edit&ID=${order.customerItemID}`} target="_blank">
