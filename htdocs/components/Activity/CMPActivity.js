...
import CMPGatherManagementReviewDetails from "./components/CMPGatherManagementReviewDetails.js?v=10";
class CMPActivity extends React.Component {
    ...
    render() { 
        ...
        return ( 
            ...
            action==='gatherManagementReviewDetails'?el(CMPGatherManagementReviewDetails):null,
            )
            );
    }
}
