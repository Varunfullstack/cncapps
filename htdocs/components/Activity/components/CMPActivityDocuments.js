...
class CMPActivityDocuments extends MainComponent {
    ...
    getDocumentsElement = () => {
        ...
        let columns = [
          ...
          
          {
            ...
            sortable: false,
            content: (document) =>
            el(ToolTip,{title:"Delete the document",content:
              el("i", {
        ...
        return el(
          ...
          el(ToolTip,{title:"Select Files to uploads",content: el("i", {
          ...
          uploadFiles.length > 0
            ? el(ToolTip,{title:"Upload Files",content:
             el("i", {
...
export default CMPActivityDocuments;