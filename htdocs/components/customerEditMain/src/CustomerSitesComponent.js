...
class CustomerSitesComponent extends React.Component {
    ...
    componentDidMount() {
        ...
        Promise.all([
            fetch('?action=getCustomerSitesData&customerID=' + this.props.customerID)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    ReactDOM.render(React.createElement(CustomerSitesComponent, {customerID: domContainer.dataset.customerId}), domContainer);
});