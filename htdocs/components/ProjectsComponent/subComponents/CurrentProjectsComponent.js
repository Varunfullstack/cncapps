    ...
    getProjectsElement = () => {
        ...
        if (projectsSummary) {
            projects = projects.filter(p => {
                ...
                return !(indx >= 0 && !projectsSummary[indx].filter);
        ...
        const columns = [
            ...
            },
            {
                ...
                content: (project) => <a style={{color: 'black'}}
                                         href={`Projects.php?action=edit&&projectID=${project.projectID}`}>{project.description}</a>
            ...
            },
            {
                ...
                content: (project) => (
                    <a href={`Projects.php?action=edit&projectID=${project.projectID}`}> <i
                        className="fal fa-edit icon pointer"></i></a>
                ),
            },
            {
                path: "1",
