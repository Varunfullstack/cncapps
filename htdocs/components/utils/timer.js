class Timer extends React.Component {
    ...
    render() { 
        ...
        el("input",{type:"number",disabled,max:23,min:0, placeholder:"HH",style:{width:35,height:18.400,marginRight:0},onChange:(event)=>this.setValue(event.target.value,data.minutes),defaultValue:data.hours}),        
