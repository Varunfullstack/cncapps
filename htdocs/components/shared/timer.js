    ...
    render() {
        ...
        return (el("div", {style: {display: "Flex", flexDirection: "row"}},
            el("input", {
                ...
                min: 0,
                placeholder: "HH",
                style: {width: 35, height: 18.400, marginRight: 0},
                onChange: (event) => this.setValue(event.target.value, data.minutes),
                value: data.hours
            }),
            el("input", {
                type: "number",
                ...
                min: 0,
                placeholder: "MM",
                style: {width: 35, height: 18.400, margin: 0},
                onChange: (event) => this.setValue(data.hours, event.target.value),
                value: data.minutes
            }),
        ));
    }
