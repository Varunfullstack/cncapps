...
class HomeComponent extends MainComponent {
    ...
    getDailyStats=()=>{
        return <iframe style={{border:0,overflow:"hidden",overflowX:"hidden",overflowY:"hidden",height:"95%",minWidth:"200",position:"absolute",top:40,left:0,right:0,bottom:0}}  width="100%" height="100%" src="popup.php?action=dailyStats"></iframe>
    }
    getTeamCharts(){
        return <iframe style={{border:0,overflow:"hidden",overflowX:"hidden",overflowY:"hidden",height:"95%",minWidth:"200",position:"absolute",top:40,left:0,right:0,bottom:0}}  width="100%" height="100%" src="index.php?action=charts"></iframe>
    }
    render() {   
