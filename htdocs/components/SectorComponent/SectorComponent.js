...
import APISectors from "./services/APISectors.js";
import '../style.css';
import './SectorComponent.css';

class SectorComponent extends MainComponent {
   api=new APISectors();
    constructor(props) {
        super(props);
        this.state = {
...
document.addEventListener('DOMContentLoaded', () => {
    const domContainer = document.querySelector("#reactSector");
    if (domContainer)
        ReactDOM.render(React.createElement(SectorComponent), domContainer);
});