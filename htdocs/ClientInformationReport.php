...
<table width="100%" border="0" cellspacing="0" cellpadding="1">
	<tr> 
		...
		<td width="44%" align="right" valign="top"><div align="right"><img src="images/cnc_logo.png" alt="CNC Logo" height="157" align="top"></div></td>
	</tr>
</table>
<BR/>
<table width="120%" border="1" cellpadding="3" bordercolor="#999999" class="information">
	...
	<tr> 
		...
		<td colspan="5" valign="top">
			<P class="addressLine"><?php echo Controller::htmlDisplayText($dsSite->getValue('add1')); ?></P>
			<P class="addressLine"><?php echo Controller::htmlDisplayText($dsSite->getValue('add2')); ?></P>
			<P class="addressLine"><?php echo Controller::htmlDisplayText($dsSite->getValue('add3')); ?></P>
			<P class="addressLine"><?php echo Controller::htmlDisplayText($dsSite->getValue('town')); ?></P>
			<P class="addressLine"><?php echo Controller::htmlDisplayText($dsSite->getValue('county')); ?></P>
			<P class="addressLine"><?php echo Controller::htmlDisplayText($dsSite->getValue('postcode')) ;?></P>
		</td>
	</tr>
	<tr> 
	...
	<tr> 
		<td colspan="6" valign="top" <?php if (!$newClient) echo 'height="510px"'; ?> ><p><strong>Reason For Contact:</strong></p>
...
<?php
} // end if ($dsCustomer->getValue('prospectFlag') == 'Y')
?>
</table>
<P class="pageBreak"></P>
<table width="100%" border="0" cellspacing="0" cellpadding="1">
	<tr> 
		...
		<td width="44%" align="right" valign="top"><div align="right"><img src="images/cnclogo.jpeg" alt="CNC Logo" width="421" height="157" align="top"></div></td>
	</tr>
</table>
<br/>
