...
while ($test->fetchNext()) {
    $template->set_var(
        [
            ...
            "mailshot1Flag"        => $test->getValue(DBEJContactAudit::mailshot1Flag),
            ...
            "mailshot5Flag"        => $test->getValue(DBEJContactAudit::mailshot5Flag),
            "mailshot6Flag"        => $test->getValue(DBEJContactAudit::mailshot6Flag),
            "mailshot7Flag"        => $test->getValue(DBEJContactAudit::mailshot7Flag),
            "mailshot8Flag"        => $test->getValue(DBEJContactAudit::mailshot8Flag),
            "mailshot9Flag"        => $test->getValue(DBEJContactAudit::mailshot9Flag),
            "mailshot10Flag"       => $test->getValue(DBEJContactAudit::mailshot10Flag),
            ...
            "autoCloseEmailFlag"   => $test->getValue(DBEJContactAudit::autoCloseEmailFlag),
