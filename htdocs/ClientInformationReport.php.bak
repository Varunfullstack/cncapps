<html>
<head>
    <title><?php echo Controller::htmlDisplayText($dsCustomer->getValue(DBECustomer::name)); ?></title>
...
>
    <tr>
        ...
        <td width="44%"
            ...
            valign="top"
        >
            <div align="right"><img src="images/cnc_logo.png"
                                    alt="CNC Logo"
                                    height="157"
                                    align="top"
                ></div>
...
>
    <tr>
        ...
        <td colspan="5"><?php echo Controller::htmlDisplayText($dsCustomer->getValue(DBECustomer::name)); ?></td>
    </tr>
    <tr>
        <td valign="top"
            class="label"
    ...
    <tr>
        ...
        <td colspan="5"><?php echo Controller::htmlDisplayText($dsContact->getValue(DBEContact::title) . ' ' . $dsContact->getValue(DBEContact::firstName) . ' ' . $dsContact->getValue(DBEContact::lastName)); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td colspan="5"><?php echo Controller::htmlDisplayText($dsContact->getValue(DBEContact::fax)); ?></td>
    </tr>
    <tr>
        <td class="label">Email:</td>
        <td colspan="5"><?php echo Controller::htmlDisplayText($dsContact->getValue(DBEContact::email)); ?></td>
    </tr>
    <tr>
    ...
    <tr>
        <td colspan="6"
            valign="top" <?php if (!$newClient) echo 'height="510px"'; ?> ><p><strong>Reason For
                    Contact:</strong></p>
...
>
    <tr>
        ...
        <td width="44%"
            ...
            valign="top"
        >
            <div align="right"><img src="images/cnclogo.jpeg"
                                    alt="CNC Logo"
                                    width="421"
                                    height="157"
                                    align="top"
