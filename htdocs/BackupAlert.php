...
define('BACKUP_ALERT_EMAIL_FROM_USER', 'sales@cnc-ltd.co.uk'); 
define('BACKUP_ALERT_EMAIL_SUBJECT', 'MySQL Backup Problem (raised by "Backup Integrity Check" scheduled task)'); 
define('BACKUP_ALERT_BACKUP_FILE', 'mysqldump.sql.gz'); 

define('BACKUP_ALERT_MIN_FILE_SIZE_BYTES', 10485760); 
define('BACKUP_ALERT_MIN_AGE_HOURS', 24); 
