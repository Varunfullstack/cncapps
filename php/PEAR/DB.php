...
class DB
{
    ...
    public static function parseDSN($dsn)
    {
        ...
        if (strpos(
            ...
            list($proto_opts, $parsed['port']) = explode(
                ':',
                $proto_opts
            );
        }
    ...
    )
    {
        ...
        if (is_string($dsn) && strpos(
                $dsn,
                'tcp'
            ) === false && $dsnArray['protocol'] == 'tcp') {
...
class DB_Error extends PEAR_Error
{
     ...
     * @see PEAR_Error
     */
    function __construct($code = DB_ERROR,
