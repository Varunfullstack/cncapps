...
class BUPDFSupportContract extends BaseObject{
  ...
  var $_customerHasServiceDeskContract;
	...
	*
	*/
	function BUPDFSupportContract(&$owner, &$dsContract, &$dsCustomerItem, &$dsSite, &$dsCustomer, &$buActivity, $customerHasServiceDeskContract){
		$this->constructor($owner, $dsContract, $dsCustomerItem, $dsSite, $dsCustomer, $buActivity, $customerHasServiceDeskContract);
	}
	function constructor(&$owner, &$dsContract, &$dsCustomerItem, &$dsSite, &$dsCustomer, &$buActivity, $customerHasServiceDeskContract){
