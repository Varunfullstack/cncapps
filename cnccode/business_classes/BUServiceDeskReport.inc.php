<?php	
  ...
  */
  ...
  class BUServiceDeskReport extends Business {
    ...
    * @access Public
    */
    function BUServiceDeskReport(&$owner) {
    ...
    function getMonthlyReport()
    {
      ...
      $fields['totalIncidentsWithinSlaYtd'] = $this->getCountIncidents( array( 'sla' => 'Y', 'withinSla' => 'Y', 'ytd' => true ));
...
// end root causes
    ...
    function getCustomerReportFields()
    {
      ...
      $fields['totalIncidentsSdWithinSla'] = $this->getCountIncidents( array( 'contractKey' => 'SD', 'sla' => 'Y', 'withinSla' => 'Y' ));
      $fields['totalIncidentsScWithinSla'] = $this->getCountIncidents( array( 'contractKey' => 'SC', 'sla' => 'Y', 'withinSla' => 'Y' ));
      $fields['totalIncidentsPpWithinSla'] = $this->getCountIncidents( array( 'contractKey' => 'PP', 'sla' => 'Y', 'withinSla' => 'Y' ));
      $fields['totalIncidentsTmWithinSla'] = $this->getCountIncidents( array( 'contractKey' => 'TM', 'sla' => 'Y', 'withinSla' => 'Y' ) );

      $fields['totalIncidentsSdMissedSla'] = $this->getCountIncidents( array( 'contractKey' => 'SD', 'sla' => 'Y', 'withinSla' => 'N' ));
      $fields['totalIncidentsScMissedSla'] = $this->getCountIncidents( array( 'contractKey' => 'SC', 'sla' => 'Y', 'withinSla' => 'N' ));
