...
// 			$dsOrdhead->setValue('payMethod', 'F');	// switch to paymentTermsID
	...
	function setInvoiceSiteAndContact($customerID, $siteNo, &$dsOrdhead){
		...
		$buCustomer->getSiteByCustomerIDSiteNo($customerID, $siteNo, $dsSite);
 		...
 		$dsOrdhead->setValue('invAdd1', $dsSite->getValue('add1'));
 		$dsOrdhead->setValue('invAdd2', $dsSite->getValue('add2'));
 		$dsOrdhead->setValue('invAdd3', $dsSite->getValue('add3'));
 		$dsOrdhead->setValue('invTown', $dsSite->getValue('town'));
 		$dsOrdhead->setValue('invCounty', $dsSite->getValue('county'));
 		$dsOrdhead->setValue('invPostcode', $dsSite->getValue('postcode'));
 		$dsOrdhead->setValue('invSitePhone', $dsSite->getValue('phone'));
		$buCustomer->getContactByID($dsSite->getValue('invContactID'), $dsContact);
	...
	function setDeliverySiteAndContact($customerID, $siteNo, &$dsOrdhead){
		...
		$buCustomer->getSiteByCustomerIDSiteNo($customerID, $siteNo, $dsSite);
 		...
 		$dsOrdhead->setValue('delAdd1', $dsSite->getValue('add1'));
 		$dsOrdhead->setValue('delAdd2', $dsSite->getValue('add2'));
 		$dsOrdhead->setValue('delAdd3', $dsSite->getValue('add3'));
 		$dsOrdhead->setValue('delTown', $dsSite->getValue('town'));
 		$dsOrdhead->setValue('delCounty', $dsSite->getValue('county'));
 		$dsOrdhead->setValue('delPostcode', $dsSite->getValue('postcode'));
 		$dsOrdhead->setValue('delSitePhone', $dsSite->getValue('phone'));
		$buCustomer->getContactByID($dsSite->getValue('delContactID'), $dsContact);
	...
	function updateInvoiceAddress($ordheadID, $siteNo){
		...
		$dbeOrdhead->setValue('invSiteNo', $siteNo);
 		$dbeOrdhead->setValue('invAdd1', $dsSite->getValue('add1'));
 		$dbeOrdhead->setValue('invAdd2', $dsSite->getValue('add2'));
 		$dbeOrdhead->setValue('invAdd3', $dsSite->getValue('add3'));
 		$dbeOrdhead->setValue('invTown', $dsSite->getValue('town'));
 		$dbeOrdhead->setValue('invCounty', $dsSite->getValue('county'));
 		$dbeOrdhead->setValue('invPostcode', $dsSite->getValue('postcode'));
 		$dbeOrdhead->setValue('invSitePhone', $dsSite->getValue('phone'));
		$buCustomer->getContactByID($dsSite->getValue('invContactID'), $dsContact);
	...
	function updateDeliveryAddress($ordheadID, $siteNo){
		...
		$dbeOrdhead->setValue('delSiteNo', $siteNo);
 		$dbeOrdhead->setValue('delAdd1', $dsSite->getValue('add1'));
 		$dbeOrdhead->setValue('delAdd2', $dsSite->getValue('add2'));
 		$dbeOrdhead->setValue('delAdd3', $dsSite->getValue('add3'));
 		$dbeOrdhead->setValue('delTown', $dsSite->getValue('town'));
 		$dbeOrdhead->setValue('delCounty', $dsSite->getValue('county'));
 		$dbeOrdhead->setValue('delPostcode', $dsSite->getValue('postcode'));
 		$dbeOrdhead->setValue('delSitePhone', $dsSite->getValue('phone'));
		$buCustomer->getContactByID($dsSite->getValue('delContactID'), $dsContact);
