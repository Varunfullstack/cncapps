...
class BUPDF extends BaseObject{
	...
	var $fontSize='';
	var $filename='';
	function BUPDF(&$owner, $filename, $author, $title, $creator, $subject, $paperSize){
		$this->constructor($owner, $filename, $author, $title, $creator, $subject, $paperSize);
	}
	function constructor(&$owner, $filename, $author, $title, $creator, $subject, $paperSize){
