...
//                $dbeJProblem->getValue(DBEProblem::sta)
                $templateName = '@customerFacing/style-3-rows-email/SRActivityInProgress/SRActivityInProgress.html.twig';
        ...
        $subject .= $dbeJProblem->getValue(DBEProblem::emailSubjectSummary);
