...
function common_getHTMLEmailFooter( $senderName, $senderEmail ){
	...
	$message = '<p><font size=2 color=navy face=Arial><span style=\'font-size:10.0pt;color:black\'>';
	...
	$message .= '<BR/><BR/>'.
		$dsHeader->getValue('name') . ', ' .
		$dsHeader->getValue('add1' ) . ', ' .
		$dsHeader->getValue('add2' ) . ', ' .
		$dsHeader->getValue('add3' ) . ', ' .
		$dsHeader->getValue('town' ) . ', ' .
		$dsHeader->getValue('county' ) . ', ' .
		$dsHeader->getValue('postcode' );

	$message .= '</span></font></p>';

	$message .= '<p><font size=2 face=Arial><span lang=EN-GB style=\'font-size:10.0pt;mso-ansi-language:EN-GB\'>E-Mail:';
	$message .= '<a href="mailto:' . $senderEmail . '">' . $senderEmail .'</a><br>';
	$message .= 'Tel: '.$dsHeader->getValue('phone' ).'<BR/>';
	$message .= 'Tel: '.$dsHeader->getValue('fax' ).'<BR/>';
