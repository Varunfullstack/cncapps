...
require_once($cfg['path_bu'].'/BUSalesReport.inc.php');
require_once($cfg['path_func'].'/Common.inc.php');
require_once("Mail.php");
require_once("Mail/mime.php");

class CTSalesByCustomerReport extends CTCNC {
	...
	*/
	function salesByCustomer()
	{
		...
		$this->setTemplateFiles('SalesByCustomerReport', 'SalesByCustomerReport.inc');
