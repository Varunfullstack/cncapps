...
class CTContractAndNumbersReport extends CTCNC
{
  ...
  private function getContractAndNumberData()
  {
    ...
    $queryString = "SELECT
                  ...
                  concat('M ',coalesce(mainCount, 0),', SV ',coalesce(supervisorCount,0),', S ', coalesce(supportCount, 0),', D ', coalesce(delegateCount, 0),', T ', coalesce(actualSupportedUsersCount, 0) ) as supportedUsers,
