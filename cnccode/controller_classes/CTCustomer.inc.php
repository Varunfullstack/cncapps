...
class CTCustomer extends CTCNC
{
    ...
    function setContact(&$contactArray)
    {
        ...
        foreach ($contactArray as $key => $value) {
            ...
            if ($this->dsContact->getValue('FirstName') == '') {
                $this->setFormErrorOn();
            ...
            if ($validEmail) {
                $this->dsContact->setValue('Email', $email);
            }
...
'htmlFmt' => CT_HTML_FMT_POPUP
        ...
        */
        ...
        while ($this->dsSite->fetchNext()) {
            ...
            if ($this->buCustomer->canDeleteSite($this->dsSite->getValue("CustomerID"),
                                                 $this->dsSite->getValue("SiteNo"))) {
