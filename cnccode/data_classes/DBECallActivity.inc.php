...
class DBECallActivity extends DBEntity{
	...
	* @see constructor()
	*/
	function DBECallActivity(&$owner){
...
class DBEJCallActivity extends DBECallActivity{
	...
	* @see constructor()
	*/
	function DBEJCallActivity(&$owner){
		$this->constructor($owner);
	}
	/**
	* constructor
...
//    $this->addColumn("projectID", DA_ID, DA_ALLOW_NULL, "(SELECT projectID FROM project WHERE pro_custno = customerID LIMIT 0,1 )");
