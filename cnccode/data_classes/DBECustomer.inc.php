...
class DBECustomer extends DBCNCEntity
{
    ...
    )
    {
        ...
        if ($newCustomerFromDate != '') {
            $queryString .=
                " AND " . $this->getDBColumnName(self::becameCustomerDate) . ">='" . mysqli_real_escape_string($this->db->link_id(),
                                                                                                               $newCustomerFromDate) . "'";
        }
        ...
        if ($droppedCustomerFromDate != '') {
            $queryString .=
                " AND " . $this->getDBColumnName(self::droppedCustomerDate) . ">='" . mysqli_real_escape_string($this->db->link_id(),
        ...
        $queryString .= " GROUP BY " . $this->getDBColumnName(self::customerID) . " ORDER BY " . $this->getDBColumnName(self::name);
