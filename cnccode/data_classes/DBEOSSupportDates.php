...
class DBEOSSupportDates extends DBEntity
{
    ...
    const thirdPartyPatchingCapable = "thirdPartyPatchingCapable";
    ...
    public function __construct(&$owner)
    {
        ...
        $this->addColumn(self::isServer, DA_BOOLEAN, DA_NOT_NULL, null, 0);
        $this->addColumn(self::friendlyName, DA_STRING, DA_ALLOW_NULL);
        $this->addColumn(self::thirdPartyPatchingCapable, DA_BOOLEAN, DA_NOT_NULL, null, 0);
