...
class DBEExpense extends DBEntity
{
    ...
    function __construct(&$owner)
    {
        ...
        $this->addColumn("callActivityID", DA_ID, DA_NOT_NULL, "exp_callactivityno");
        $this->addColumn("mileage", DA_INTEGER, DA_ALLOW_NULL, "exp_mileage");
        $this->addColumn("value", DA_FLOAT, DA_ALLOW_NULL, "exp_value");
        $this->addColumn("vatFlag", DA_YN, DA_NOT_NULL, "exp_vat_flag");
        $this->addColumn("exportedFlag", DA_YN, DA_NOT_NULL, "exp_exported_flag");
        $this->setPK(0);
...
class DBEJExpense extends DBEExpense
{
    ...
    function __construct(&$owner)
    {
        ...
        $this->addColumn("expenseExportedFlag", DA_YN, DA_ALLOW_NULL, "caa_expexport_flag");
        $this->addColumn("mileageFlag", DA_YN, DA_ALLOW_NULL, "ext_mileage_flag");        // indicates whether this is a mileage type
        $this->addColumn("defaultVatFlag", DA_YN, DA_ALLOW_NULL, "ext_vat_flag");            // default VAT included in value flag
        $this->setAddColumnsOff();
    }
